...
// @access Public
router.get('/test', (req, res) => res.json({ msg: 'profile router is work' }));
...
router.post(
	...
	passport.authenticate('jwt', { session: false }),
	(req, res) => {
		const { errors, isValidate } = validateProfileInput(req.body);
...
router.post(
	...
	passport.authenticate('jwt', { session: false }),
	(req, res) => {
		const { errors, isValidate } = validateExperienceInput(req.body);
...
router.post(
	...
	passport.authenticate('jwt', { session: false }),
	(req, res) => {
		const { errors, isValidate } = validateEducationInput(req.body);
